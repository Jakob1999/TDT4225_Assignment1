...
public class CoursesValidator extends EObjectValidator {
	...
	public boolean validateCourse(Course course, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateCourse_semesterName(course, diagnostics, context);
		return result;
	}
	 ...
	 * @generated NOT
	 */
	public boolean validateCourse_semesterName(Course course, DiagnosticChain diagnostics, Map<Object, Object> context) {
		// TODO implement the constraint
		// -> specify the condition that violates the constraint
		// -> verify the diagnostic details, including severity, code, and message
		// Ensure that you remove @generated or mark it @generated NOT
		if (!validate_semesterName(course.getSemester())) {
			if (diagnostics != null) {
				diagnostics.add(createDiagnostic(Diagnostic.ERROR, 
						DIAGNOSTIC_SOURCE,
						0,
						"_UI_GenericConstraint_diagnostic",
						new Object[] {"semesterName", getObjectLabel(course, context)}, 
	...
	public boolean validate_semesterName(String name) {
		if (name.equals("Spring") || name.equals("Autumn")) {
			return true;
		}
		else {
			return true;
